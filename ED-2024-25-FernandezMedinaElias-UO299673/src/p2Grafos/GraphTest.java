...
//	}
	...
	void getCentreNode() {
		...
		assertTrue(g.addEdge("A", "C", 8));
		assertTrue(g.addEdge("B", "C", 3));
		assertTrue(g.addEdge("B", "D", 6));
		assertTrue(g.addEdge("C", "D", 1));
		assertTrue(g.addEdge("D", "B", 2));
		assertEquals("B", g.getCentreNode());
	}
	/**
	 * Test método es grafo conexo
	 */
	@Test
	void isGraphConnected() {
		...
		assertTrue(g.addEdge("B", "D", 1));
		assertTrue(g.addEdge("D", "C", 1));
		assertTrue(g.addEdge("C", "A", 1));
		assertTrue(g.isGraphConnected());
		Graph g2 = new Graph(10);
		assertTrue(g2.addNode("A"));
		assertTrue(g2.addNode("B"));
		assertTrue(g2.addNode("C"));
		assertTrue(g2.addNode("D"));
		assertTrue(g2.addEdge("A", "B", 1));
		assertTrue(g2.addEdge("B", "C", 1));
		assertTrue(g2.addEdge("A", "C", 1));
		assertTrue(g2.addEdge("B", "D", 1));
		assertFalse(g2.isGraphConnected());
	}
	/**
	 * Test desidad de un grafo
	 */
	@Test
	void graphDensity() {
		assertTrue(g.addNode("A"));
		...
		assertTrue(g.addEdge("D", "C", 1));
		assertTrue(g.addEdge("C", "A", 1));
		assertEquals(0.67, g.graphDensity());
		Graph g2 = new Graph(10);
		assertTrue(g2.addNode("A"));
		assertTrue(g2.addNode("B"));
		assertTrue(g2.addNode("C"));
		assertTrue(g2.addNode("D"));
		assertEquals(0, g2.graphDensity());
		Graph g3 = new Graph(10);
		assertTrue(g3.addNode("A"));
		assertTrue(g3.addNode("B"));
		assertTrue(g3.addNode("C"));
		assertTrue(g3.addEdge("A", "A", 1));
		assertTrue(g3.addEdge("A", "B", 1));
		assertTrue(g3.addEdge("A", "C", 1));
		assertTrue(g3.addEdge("B", "A", 1));
		assertTrue(g3.addEdge("B", "B", 1));
		assertTrue(g3.addEdge("B", "C", 1));
		assertTrue(g3.addEdge("C", "A", 1));
		assertTrue(g3.addEdge("C", "B", 1));
		assertTrue(g3.addEdge("C", "C", 1));
		assertEquals(1, g3.graphDensity());
	}
	/**
	 * Test método máximas aristas
	 */
	@Test
	void getMaxNumberOfEdges() {
		assertTrue(g.addNode("A"));
		assertTrue(g.addNode("B"));
		assertTrue(g.addNode("C"));
		assertTrue(g.addNode("D"));
		...
		assertTrue(g.addEdge("D", "C", 1));
		assertTrue(g.addEdge("C", "A", 1));
		assertEquals(6, g.getMaxNumberOfEdges());
		Graph g2 = new Graph(10);
		assertTrue(g2.addNode("A"));
		assertTrue(g2.addNode("B"));
		assertTrue(g2.addNode("C"));
		assertTrue(g2.addNode("D"));
		assertTrue(g2.addEdge("A", "B", 1));
		assertTrue(g2.addEdge("A", "A", 1));
		assertTrue(g2.addEdge("B", "D", 1));
		assertTrue(g2.addEdge("D", "C", 1));
		assertTrue(g2.addEdge("C", "A", 1));
		assertEquals(10, g2.getMaxNumberOfEdges());
	}
